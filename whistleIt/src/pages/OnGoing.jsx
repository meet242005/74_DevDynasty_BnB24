...
const OnGoing = () => {
  ...
  useEffect(() => {
    const fetchCases = async () => {
      ...
      setCases(
        casesData.filter((caseItem) => caseItem.current_status === "onGoing")
      );
    };
          ...
          <div className=" overflow-y-scroll overflow-x-hidden h-[40rem]">
            {cases.map((caseItem) => (
              <div
                ...
                className="bg-white rounded-lg shadow-2xl cursor-pointer ml-2 p-4 mb-4 mr-9 border-2 border-gray-200"
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
      <div className="bg-white rounded-lg shadow-2xl p-4">
        <form onSubmit={handleSubmit}>
          ...
          <p>Are you sure the investigation is completed?</p>
